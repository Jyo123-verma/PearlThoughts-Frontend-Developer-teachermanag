...
import { availableSubjects, availableClasses, addTeacher } from "@/lib/data"
import { X, Plus, User, Mail, Phone, MapPin, GraduationCap, IndianRupee } from "lucide-react"
...
export function AddTeacherModal({ open, onClose }: AddTeacherModalProps) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const newTeacher = {
      name: formData.name,
      staffId: `EMP${String(Date.now()).slice(-3)}`,
